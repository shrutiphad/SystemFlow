...
export default function FilterSortBar({ filters, onChange, onNewTask }) {
  return (
    <div className="mb-4 flex flex-wrap items-center gap-2">
      ...
      <button onClick={onNewTask} className="ml-auto flex items-center gap-1.5 rounded-lg bg-accent-gradient px-3.5 py-2 text-sm font-medium text-white shadow-glow transition-opacity hover:opacity-90">
